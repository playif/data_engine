...
["_interceptors", "dart:_interceptors", , J, {
  ...
  Interceptor: {
    ...
    "%": "CSS|DOMError|FileError|MediaKeyError|Navigator|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedLengthList|SVGAnimatedNumber|SVGAnimatedNumberList"
  },
  JSBool: {
    "^": "Interceptor;",
    toString$0: function(receiver) {
...
["_isolate_helper", "dart:_isolate_helper", , H, {
  ...
  _JsDeserializer: {
    ...
    deserializeSendPort$1: function(list) {
      var managerId, t1, isolateId, receivePortId, isolate, receivePort;
      H.listTypeCheck(list);
      managerId = H.intTypeCheck(J.$index$asx(list, 1));
      t1 = list.length;
      if (2 >= t1)
        return H.ioore(list, 2);
      isolateId = H.intTypeCheck(list[2]);
      if (3 >= t1)
        return H.ioore(list, 3);
      receivePortId = H.intTypeCheck(list[3]);
  ...
  _Deserializer: {
    ...
    _deserializeList$1: function(x) {
      var id, dartList, t1, len, i;
      H.listTypeCheck(x);
      id = H.intTypeCheck(J.$index$asx(x, 1));
      if (2 >= x.length)
        return H.ioore(x, 2);
      dartList = H.listTypeCheck(x[2]);
      this._deserialized.$indexSet(0, id, dartList);
      t1 = J.getInterceptor$asx(dartList);
      len = t1.get$length(dartList);
      for (i = 0; i < len; ++i) {
        if (i >= dartList.length)
          return H.ioore(dartList, i);
        t1.$indexSet(dartList, i, this._deserializeHelper$1(dartList[i]));
      }
      return dartList;
    },
    _deserializeMap$1: function(x) {
      var result, id, t1, keys, values, len, i, key;
      H.listTypeCheck(x);
      ...
      if (2 >= t1)
        return H.ioore(x, 2);
      keys = H.listTypeCheck(x[2]);
      if (3 >= t1)
        return H.ioore(x, 3);
      values = H.listTypeCheck(x[3]);
      len = J.get$length$asx(keys);
      H.assertHelper(len === J.get$length$asx(values));
      for (i = 0; i < len; ++i) {
        if (i >= keys.length)
        ...
        result.$indexSet(0, key, this._deserializeHelper$1(values[i]));
      }
      return result;
    },
...
["", "app.dart", , S, {
  ...
  main_bind: {
    ...
    call$1: function($name) {
      return new S.main_bind_closure($name);
    },
    $isFunction: true
  },
  main_bind_closure: {
    "^": "Closure:8;name_1",
    call$1: function(d) {
      return J.$index$asx(d, this.name_1);
    },
    $isFunction: true
  },
  main_closure: {
    "^": "Closure:8;data_2,svg_3",
    call$1: function(e) {
      var t1, p, t2;
      t1 = this.svg_3;
      p = t1.createSVGPoint();
      t2 = J.getInterceptor$x(e);
      p.x = J.get$x$x(t2.get$page(e));
      p.y = J.get$y$x(t2.get$page(e));
      p = J.matrixTransform$1$x(p, t1.getScreenCTM().inverse());
      t1 = p.x;
      t1.toString;
      t1 = "" + C.JSDouble_methods.toInt$0(H.doubleTypeCheck(Math.ceil(t1))) + ",";
      t2 = p.y;
      t2.toString;
      this.data_2.$indexSet(0, "FPS", t1 + C.JSDouble_methods.toInt$0(H.doubleTypeCheck(Math.ceil(t2))));
    },
    $isFunction: true
  },
  main_closure0: {
  ...
  main_closure1: {
    "^": "Closure:8;",
    call$1: function(d) {
      var t1 = J.getInterceptor$asx(d);
      return "translate(" + H.S(t1.$index(d, "x")) + " " + H.S(t1.$index(d, "y")) + ")  ";
    },
    $isFunction: true
  },
  main_closure2: {
  ...
  main_closure7: {
    "^": "Closure:8;",
    call$1: function(d) {
      return "rotate(" + H.S(J.$index$asx(d, "rotate")) + ")";
    },
    $isFunction: true
  },
  main_closure8: {
  ...
  main_loop: {
    "^": "Closure:12;box_0,data_4,engine_5",
    call$1: function(delta) {
      ...
      delta - t2;
      t1.lastTime_0 = delta;
      for (t1 = this.data_4, i = 0; C.JSInt_methods.$lt(i, J.get$length$asx(t1.$index(0, "list"))); ++i)
        ;
      t2 = this.engine_5;
      H.assertSubtype(t1, "$isMap", [P.String, null], "$asMap");
      t2._render$3(t1, t1, t2.svg);
...
["dart._internal", "dart:_internal", , H, {
  ...
  MappedIterable: {
    ...
    static: {MappedIterable_MappedIterable: function(iterable, $function, $S, $T) {
        var t1, t2;
        t1 = H.buildFunctionType(H.convertRtiToRuntimeType($T), [H.convertRtiToRuntimeType($S)])._assertCheck$1($function);
        t2 = H.buildFunctionType(H.convertRtiToRuntimeType($T), [H.convertRtiToRuntimeType($S)]);
        t2._assertCheck$1(t1);
        return H.assertSubtype(H.setRuntimeTypeInfo(new H.EfficientLengthMappedIterable(H.listSuperNativeTypeCheck(iterable, "$isIterable"), t2._assertCheck$1(t1)), [$S, $T]), "$isMappedIterable", [$S, $T], "$asMappedIterable");
      }}
  },
...
["dart.collection", "dart:collection", , P, {
  ...
  SetMixin: {
    ...
    join$1: function(_, separator) {
      ...
      if (separator === "")
        do {
          str = H.S(H.assertSubtypeOfRuntimeType(iterator._collection$_current, H.getTypeArgumentByIndex(iterator, 0)));
          buffer._contents += str;
        } while (iterator.moveNext$0());
      else {
        buffer.write$1(H.S(H.assertSubtypeOfRuntimeType(iterator._collection$_current, H.getTypeArgumentByIndex(iterator, 0))));
...
["dart.dom.html", "dart:html", , W, {
  ...
  CssStyleDeclaration: {
    ...
    getPropertyValue$1: function(receiver, propertyName) {
      var propValue = this._getPropertyValue$1(receiver, H.stringTypeCheck(propertyName));
  ...
  Element: {
    ...
    setAttribute$2: function(receiver, $name, value) {
      return receiver.setAttribute(H.stringTypeCheck($name), value);
    },
    $isElement: true,
    $isEventTarget: true,
    "%": ";Element"
  ...
  EventTarget: {
    ...
    addEventListener$3: function(receiver, type, listener, useCapture) {
      return receiver.addEventListener(H.stringTypeCheck(type), H.convertDartClosureToJS(H.buildFunctionType(H.getDynamicRuntimeType(), [H.buildInterfaceType(W.Event)])._assertCheck$1(listener), 1), useCapture);
    },
  ...
  UIEvent: {
    ...
    get$page: function(receiver) {
      ...
      t1 = receiver.pageX;
      t2 = receiver.pageY;
      return H.setRuntimeTypeInfo(new P.Point(H.assertSubtypeOfRuntimeType(t1, null), H.assertSubtypeOfRuntimeType(t2, null)), [null]);
    },
  ...
  Window: {
    ...
    get$animationFrame: function(receiver) {
      var t1, completer;
      t1 = P.num;
      completer = H.assertSubtype(H.setRuntimeTypeInfo(new P._SyncCompleter(H.assertSubtype(P._Future$(t1), "$is_Future", [t1], "$as_Future")), [t1]), "$isCompleter", [t1], "$asCompleter");
...
["dart.dom.svg", "dart:svg", , P, {
  ...
  AnimateElement: {
    "^": "AnimationElement;",
    $isAnimateElement: true,
    "%": "SVGAnimateElement"
  },
  AnimateTransformElement: {
    "^": "AnimationElement;",
    $isAnimateTransformElement: true,
  ...
  AnimationElement: {
    "^": "SvgElement;",
    $isAnimationElement: true,
    "%": "SVGAnimateMotionElement;SVGAnimationElement"
  },
  CircleElement: {
    "^": "GeometryElement;",
    $isCircleElement: true,
    "%": "SVGCircleElement"
  },
  GElement: {
    "^": "GraphicsElement;",
  ...
  GraphicsElement: {
    "^": "SvgElement;",
    "%": "SVGAElement|SVGClipPathElement|SVGDefsElement|SVGForeignObjectElement|SVGImageElement|SVGSwitchElement|SVGUseElement;SVGGraphicsElement"
  },
  Matrix: {
    "^": "Interceptor;",
    $isMatrix: true,
  ...
  _AttributeClassSet: {
    ...
    readClasses$0: function() {
      ...
      if (classname == null)
        return H.assertSubtype(s, "$isSet", [P.String], "$asSet");
      for (t1 = classname.split(" "), t2 = H.getTypeArgumentByIndex(t1, 0), H.listSuperNativeTypeCheck(t1, "$isIterable"), t3 = t1.length, t1 = H.assertSubtype(H.setRuntimeTypeInfo(new H.ListIterator(H.listSuperNativeTypeCheck(t1, "$isIterable"), t3, 0, H.assertSubtypeOfRuntimeType(null, t2)), [t2]), "$isIterator", [H.getTypeArgumentByIndex(t1, 0)], "$asIterator"); t1.moveNext$0();) {
        trimmed = J.trim$0$s(H.stringTypeCheck(H.assertSubtypeOfRuntimeType(t1._current, H.getTypeArgumentByIndex(t1, 0))));
        if (trimmed.length !== 0)
          s.add$1(0, trimmed);
      }
...
["", "package:data_engine/data_engine.dart", , T, {
  "^": "",
  DataEngine: {
    "^": "Group;svg,_path,_tag,_stateList,_enterList,_exitList,_eventMap,_attrMap,_cssMap,_classSet,_svgMap,_toBeRemovedSVG,_text"
  },
  Shape: {
    "^": "Object;_path,_tag,_stateList,_enterList,_exitList,_eventMap,_attrMap,_cssMap,_classSet,_svgMap,_toBeRemovedSVG,_text",
    _getElement$1: function(d) {
      var temp, element;
      switch (this._tag) {
        case "circle":
          temp = H.interceptedTypeCheck(H.interceptedTypeCheck(C.HtmlDocument_methods.createElementNS$2(document, "http://www.w3.org/2000/svg", "circle"), "$isSvgElement"), "$isCircleElement");
          element = temp;
          break;
        case "rect":
          temp = H.interceptedTypeCheck(H.interceptedTypeCheck(C.HtmlDocument_methods.createElementNS$2(document, "http://www.w3.org/2000/svg", "rect"), "$isSvgElement"), "$isRectElement");
          element = temp;
          break;
        case "text":
          temp = H.interceptedTypeCheck(H.interceptedTypeCheck(C.HtmlDocument_methods.createElementNS$2(document, "http://www.w3.org/2000/svg", "text"), "$isSvgElement"), "$isTextElement");
          element = temp;
          break;
        case "g":
          temp = H.interceptedTypeCheck(H.interceptedTypeCheck(C.HtmlDocument_methods.createElementNS$2(document, "http://www.w3.org/2000/svg", "g"), "$isSvgElement"), "$isGElement");
          element = temp;
          break;
        case "anim":
          temp = H.interceptedTypeCheck(H.interceptedTypeCheck(C.HtmlDocument_methods.createElementNS$2(document, "http://www.w3.org/2000/svg", "animate"), "$isSvgElement"), "$isAnimateElement");
          element = temp;
          break;
        case "set":
          temp = H.interceptedTypeCheck(H.interceptedTypeCheck(C.HtmlDocument_methods.createElementNS$2(document, "http://www.w3.org/2000/svg", "set"), "$isSvgElement"), "$isSetElement");
          element = temp;
          break;
        case "transform":
          temp = H.interceptedTypeCheck(H.interceptedTypeCheck(C.HtmlDocument_methods.createElementNS$2(document, "http://www.w3.org/2000/svg", "animateTransform"), "$isSvgElement"), "$isAnimateTransformElement");
          element = temp;
          break;
        default:
          element = null;
      }
      this._setEnterAnim$2(element, d);
      this._setEvent$2(element, d);
      return H.interceptedTypeCheck(element, "$isElement");
    },
    _setEnterAnim$2: function(element, d) {
      var t1, t2, a, anim;
      for (t1 = this._enterList, t2 = H.getTypeArgumentByIndex(t1, 0), H.listSuperNativeTypeCheck(t1, "$isIterable"), t1 = H.assertSubtype(H.setRuntimeTypeInfo(new H.ListIterator(H.listSuperNativeTypeCheck(t1, "$isIterable"), 0, 0, H.assertSubtypeOfRuntimeType(null, t2)), [t2]), "$isIterator", [H.getTypeArgumentByIndex(t1, 0)], "$asIterator"), t2 = J.getInterceptor$x(element); t1.moveNext$0();) {
        a = H.assertSubtypeOfRuntimeType(t1._current, H.getTypeArgumentByIndex(t1, 0));
        anim = H.interceptedTypeCheck(a._getElement$1(d), "$isAnimationElement");
        a._setAttr$2(anim, d);
        t2.append$1(element, anim);
      }
    },
    _setExitAnim$2: function(element, d) {
      var t1, t2, t3, a, anim;
      t1 = {};
      t1.count_0 = 0;
      t1 = new T.Shape__setExitAnim_remove(t1, element);
      for (t2 = this._exitList, t3 = H.getTypeArgumentByIndex(t2, 0), H.listSuperNativeTypeCheck(t2, "$isIterable"), t2 = H.assertSubtype(H.setRuntimeTypeInfo(new H.ListIterator(H.listSuperNativeTypeCheck(t2, "$isIterable"), 0, 0, H.assertSubtypeOfRuntimeType(null, t3)), [t3]), "$isIterator", [H.getTypeArgumentByIndex(t2, 0)], "$asIterator"), t3 = J.getInterceptor$x(element); t2.moveNext$0();) {
        a = H.assertSubtypeOfRuntimeType(t2._current, H.getTypeArgumentByIndex(t2, 0));
        anim = H.interceptedTypeCheck(a._getElement$1(d), "$isAnimationElement");
        J.addEventListener$2$x(anim, "endEvent", t1);
        a._setAttr$2(anim, d);
        t3.append$1(element, anim);
      }
    },
    _setAttr$2: function(element, d) {
      var t1, t2, t3, t4, attr, value;
      H.interceptedTypeCheck(element, "$isElement");
      for (t1 = this._attrMap, t2 = t1.get$keys(), t3 = t2._map, t4 = H.getTypeArgumentByIndex(t2, 0), t4 = H.setRuntimeTypeInfo(new P.LinkedHashMapKeyIterator(t3, t3._modifications, null, H.assertSubtypeOfRuntimeType(null, t4)), [t4]), t4._cell = t4._map._first, H.assertSubtype(t4, "$isIterator", [H.getTypeArgumentByIndex(t2, 0)], "$asIterator"), t2 = J.getInterceptor$x(element); t4.moveNext$0();) {
        attr = H.assertSubtypeOfRuntimeType(t4._collection$_current, H.getTypeArgumentByIndex(t4, 0));
        value = this._getFunctionString$2(t1.$index(0, attr), d);
        if (t2.getAttribute$1(element, attr) !== value)
          t2.setAttribute$2(element, attr, value);
      }
    },
    _setCSS$2: function(element, d) {
      var t1, t2, t3, t4, attr, value, propValue;
      H.interceptedTypeCheck(element, "$isElement");
      for (t1 = this._cssMap, t2 = t1.get$keys(), t3 = t2._map, t4 = H.getTypeArgumentByIndex(t2, 0), t4 = H.setRuntimeTypeInfo(new P.LinkedHashMapKeyIterator(t3, t3._modifications, null, H.assertSubtypeOfRuntimeType(null, t4)), [t4]), t4._cell = t4._map._first, H.assertSubtype(t4, "$isIterator", [H.getTypeArgumentByIndex(t2, 0)], "$asIterator"), t2 = J.getInterceptor$x(element); t4.moveNext$0();) {
        attr = H.assertSubtypeOfRuntimeType(t4._collection$_current, H.getTypeArgumentByIndex(t4, 0));
        value = this._getFunctionString$2(t1.$index(0, attr), d);
        t3 = t2.get$style(element);
        t3.toString;
        H.stringTypeCheck(attr);
        propValue = J._getPropertyValue$1$x(t3, attr);
        if ((propValue != null ? propValue : "") !== value)
          J.setProperty$2$x(t2.get$style(element), attr, value);
      }
    },
    _setClass$2: function(element, d) {
      var t1, t2, value;
      H.interceptedTypeCheck(element, "$isElement");
      for (t1 = this._classSet, t2 = H.setRuntimeTypeInfo(new P.LinkedHashSetIterator(t1, t1._modifications, null, H.assertSubtypeOfRuntimeType(null, null)), [null]), t2._cell = t2._set._first, H.assertSubtype(t2, "$isIterator", [H.getTypeArgumentByIndex(t1, 0)], "$asIterator"), t1 = J.getInterceptor$x(element); t2.moveNext$0();) {
        value = this._getFunctionString$2(H.assertSubtypeOfRuntimeType(t2._collection$_current, H.getTypeArgumentByIndex(t2, 0)), d);
        if (!t1.get$classes(element).readClasses$0().contains$1(0, value))
          t1.get$classes(element).add$1(0, value);
      }
    },
    _getFunctionString$2: function(func, d) {
      if (!!J.getInterceptor(func).$isFunction)
        return H.S(func.call$1(d));
      else
        return H.S(func);
    },
    _setEvent$2: function(element, d) {
      var t1, t2, t3, attr;
      H.interceptedTypeCheck(element, "$isElement");
    ...
    _setupRemove$1: function(panel) {
      var t1, t2, t3, t4, d, dPanel;
      for (t1 = this._svgMap, t2 = t1.get$keys(), t3 = t2._map, t4 = H.getTypeArgumentByIndex(t2, 0), t4 = H.setRuntimeTypeInfo(new P.LinkedHashMapKeyIterator(t3, t3._modifications, null, H.assertSubtypeOfRuntimeType(null, t4)), [t4]), t4._cell = t4._map._first, H.assertSubtype(t4, "$isIterator", [H.getTypeArgumentByIndex(t2, 0)], "$asIterator"), t2 = this._toBeRemovedSVG; t4.moveNext$0();) {
        d = H.assertSubtypeOfRuntimeType(t4._collection$_current, H.getTypeArgumentByIndex(t4, 0));
        dPanel = J.get$parent$x(t1.$index(0, d));
        if (dPanel == null ? panel == null : dPanel === panel)
          t2.$indexSet(0, d, t1.$index(0, d));
      }
    },
    _updateState$4: function(state, data, rootData, panel) {
      ...
      t1 = state._path;
      targetData = t1 != null ? data.$index(0, t1) : data;
      if (targetData != null) {
        ...
        if (!!t1.$isList) {
          ...
          t1 = state._svgMap;
          if (t1.containsKey$1(targetData)) {
            element = H.interceptedTypeCheck(t1.$index(0, targetData), "$isElement");
            t1 = state._text;
            if (t1 != null)
              element.textContent = state._getFunctionString$2(t1, targetData);
            state._setAttr$2(element, targetData);
            state._setCSS$2(element, targetData);
            state._setClass$2(element, targetData);
          } else {
            element = H.interceptedTypeCheck(state._getElement$1(targetData), "$isElement");
            t1.$indexSet(0, targetData, element);
            t1 = state._text;
            if (t1 != null)
              element.textContent = state._getFunctionString$2(t1, targetData);
            state._setAttr$2(element, targetData);
        ...
        t5 = new P.LinkedHashMapKeyIterator(t3, t3._modifications, null, H.assertSubtypeOfRuntimeType(null, t4));
        t4 = [t4];
        if (!(t4 == null))
          ;
        H.assertHelper(true);
        ...
        t5._cell = t3._first;
        H.assertSubtype(t5, "$isIterator", [H.getTypeArgumentByIndex(t2, 0)], "$asIterator");
        for (; t5.moveNext$0();) {
          d = H.assertSubtypeOfRuntimeType(t5._collection$_current, H.getTypeArgumentByIndex(t5, 0));
          svg = t1.$index(0, d);
          t2 = J.get$parent$x(svg);
          if (t2 == null ? panel == null : t2 === panel)
            state._setExitAnim$2(svg, d);
        }
      }
    },
    _render$3: function(data, rootData, panel) {
      var t1, t2, t3;
      H.assertSubtype(data, "$isMap", [P.String, null], "$asMap");
      H.interceptedTypeCheck(panel, "$isElement");
      for (t1 = this._stateList, t2 = H.getTypeArgumentByIndex(t1, 0), H.listSuperNativeTypeCheck(t1, "$isIterable"), t3 = t1.length, t1 = H.assertSubtype(H.setRuntimeTypeInfo(new H.ListIterator(H.listSuperNativeTypeCheck(t1, "$isIterable"), t3, 0, H.assertSubtypeOfRuntimeType(null, t2)), [t2]), "$isIterator", [H.getTypeArgumentByIndex(t1, 0)], "$asIterator"); t1.moveNext$0();)
        this._updateState$4(H.interceptedTypeCheck(H.assertSubtypeOfRuntimeType(t1._current, H.getTypeArgumentByIndex(t1, 0)), "$isShape"), data, rootData, panel);
    },
    append$2: function(_, path, tag) {
      var t1, t2, t3, t4, t5, t6, state;
      ...
      t5 = P.LinkedHashMap_LinkedHashMap$_empty(null, null);
      t6 = P.LinkedHashMap_LinkedHashMap$_empty(null, null);
      state = new T.Shape(path, null, H.assertSubtype([], "$isList", [T.Shape], "$asList"), H.assertSubtype([], "$isList", [T.Anim], "$asList"), H.assertSubtype([], "$isList", [T.Anim], "$asList"), t1, t2, t3, t4, t5, t6, null);
      state._tag = tag;
      C.JSArray_methods.add$1(this._stateList, state);
      return state;
    },
    $isShape: true
  },
  Shape__setExitAnim_remove: {
    "^": "Closure:8;box_0,element_1",
    call$1: function(e) {
      if (--this.box_0.count_0 === 0)
        J.remove$0$ax(this.element_1);
    },
    $isFunction: true
  },
  ...
  Group: {
    "^": "Shape;_path,_tag,_stateList,_enterList,_exitList,_eventMap,_attrMap,_cssMap,_classSet,_svgMap,_toBeRemovedSVG,_text",
    $isGroup: true
  },
  Anim: {
    "^": "Shape;"
...
["html_common", "dart:html_common", , P, {
  ...
  CssClassSetImpl: {
    ...
    get$iterator: function(_) {
      ...
      t2 = H.setRuntimeTypeInfo(new P.LinkedHashSetIterator(t1, t1._modifications, null, H.assertSubtypeOfRuntimeType(null, null)), [null]);
    ...
    add$1: function(_, value) {
      return H.boolTypeCheck(this.modify$1(new P.CssClassSetImpl_add_closure(H.stringTypeCheck(value))));
    },
    modify$1: function(f) {
      var t1, s, ret;
...
J._getPropertyValue$1$x = function(receiver, a0) {
  return J.getInterceptor$x(receiver)._getPropertyValue$1(receiver, a0);
};
...
J.matrixTransform$1$x = function(receiver, a0) {
  return J.getInterceptor$x(receiver).matrixTransform$1(receiver, a0);
};
...
function dart_precompiled($collectedClasses) {
  ...
  main_bind.builtin$cls = "main_bind";
  if (!"name" in main_bind)
    main_bind.name = "main_bind";
  $desc = $collectedClasses.main_bind;
  if ($desc instanceof Array)
    $desc = $desc[1];
  main_bind.prototype = $desc;
  function main_bind_closure(name_1) {
    this.name_1 = name_1;
  }
  main_bind_closure.builtin$cls = "main_bind_closure";
  if (!"name" in main_bind_closure)
    main_bind_closure.name = "main_bind_closure";
  $desc = $collectedClasses.main_bind_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  main_bind_closure.prototype = $desc;
  function main_closure(data_2, svg_3) {
    this.data_2 = data_2;
    this.svg_3 = svg_3;
  }
  ...
  function main_loop(box_0, data_4, engine_5) {
    this.box_0 = box_0;
    this.data_4 = data_4;
    this.engine_5 = engine_5;
  }
  main_loop.builtin$cls = "main_loop";
  if (!"name" in main_loop)
    main_loop.name = "main_loop";
  $desc = $collectedClasses.main_loop;
  if ($desc instanceof Array)
    $desc = $desc[1];
  main_loop.prototype = $desc;
  ...
  function DataEngine(svg, _path, _tag, _stateList, _enterList, _exitList, _eventMap, _attrMap, _cssMap, _classSet, _svgMap, _toBeRemovedSVG, _text) {
    this.svg = svg;
    this._path = _path;
    this._tag = _tag;
    this._stateList = _stateList;
    this._enterList = _enterList;
    this._exitList = _exitList;
    this._eventMap = _eventMap;
    this._attrMap = _attrMap;
    this._cssMap = _cssMap;
    this._classSet = _classSet;
    this._svgMap = _svgMap;
    this._toBeRemovedSVG = _toBeRemovedSVG;
    this._text = _text;
  }
  DataEngine.builtin$cls = "DataEngine";
  if (!"name" in DataEngine)
    DataEngine.name = "DataEngine";
  $desc = $collectedClasses.DataEngine;
  if ($desc instanceof Array)
    $desc = $desc[1];
  DataEngine.prototype = $desc;
  function Shape(_path, _tag, _stateList, _enterList, _exitList, _eventMap, _attrMap, _cssMap, _classSet, _svgMap, _toBeRemovedSVG, _text) {
    this._path = _path;
    this._tag = _tag;
    this._stateList = _stateList;
    this._enterList = _enterList;
  ...
  function Shape__setExitAnim_remove(box_0, element_1) {
    this.box_0 = box_0;
    this.element_1 = element_1;
  }
  Shape__setExitAnim_remove.builtin$cls = "Shape__setExitAnim_remove";
  if (!"name" in Shape__setExitAnim_remove)
    Shape__setExitAnim_remove.name = "Shape__setExitAnim_remove";
  $desc = $collectedClasses.Shape__setExitAnim_remove;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Shape__setExitAnim_remove.prototype = $desc;
  function Shape__setEvent_event(this_0, element_1, d_2, attr_3) {
    this.this_0 = this_0;
    this.element_1 = element_1;
    this.d_2 = d_2;
    this.attr_3 = attr_3;
  }
  Shape__setEvent_event.builtin$cls = "Shape__setEvent_event";
  if (!"name" in Shape__setEvent_event)
    Shape__setEvent_event.name = "Shape__setEvent_event";
  $desc = $collectedClasses.Shape__setEvent_event;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Shape__setEvent_event.prototype = $desc;
  function Group(_path, _tag, _stateList, _enterList, _exitList, _eventMap, _attrMap, _cssMap, _classSet, _svgMap, _toBeRemovedSVG, _text) {
    this._path = _path;
    this._tag = _tag;
    this._stateList = _stateList;
    this._enterList = _enterList;
  ...
  Anim.builtin$cls = "Anim";
  if (!"name" in Anim)
    Anim.name = "Anim";
  $desc = $collectedClasses.Anim;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Anim.prototype = $desc;
